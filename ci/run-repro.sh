...
mkdir -p "$ABS_OUT"
for v in variant2 variant3 variant4 variant5 variant6 variant7 variant8 variant9 variant10 variant11 variant12 variant13 variant14 variant15 variant16; do
  dest="$ABS_OUT/$v.png"
